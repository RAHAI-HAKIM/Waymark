...
/// and how this reaches SQLite lives in <c>PromotionProductConfiguration</c>.
/// </para>
/// </summary>
public sealed class PromotionProduct
{
    ...
    public required PromotionProductValueType ValueType { get; init; }
    ...
    public PromotionProductStatus Status { get; init; } = PromotionProductStatus.Active;
}
