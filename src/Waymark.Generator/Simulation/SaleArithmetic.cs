...
internal readonly record struct LineAmounts(Money Gross, Money LineTotal, TaxSplit Split);

/// <summary>
/// The sale arithmetic, written once and exactly as the application must do it (D-033, D-034).
///
/// <para>
/// The generator uses the domain's value objects rather than re-deriving anything: gross by
...
/// </para>
/// </summary>
internal static class SaleArithmetic
{
