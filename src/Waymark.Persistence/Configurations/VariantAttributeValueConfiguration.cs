...
/// <summary>
/// Maps <see cref="VariantAttributeValue"/> to <c>variant_attribute_values</c>.
/// </summary>
internal sealed class VariantAttributeValueConfiguration : IEntityTypeConfiguration<VariantAttributeValue>
{
    public void Configure(EntityTypeBuilder<VariantAttributeValue> builder)
    {
        ...
        builder.ToTable("variant_attribute_values", table =>
        {
            ...
            table.HasCheckConstraint(
                "ck_variant_attribute_values_value_bool",
                @"value_bool IS NULL OR value_bool IN (0,1)");
            table.HasCheckConstraint(
                "ck_variant_attribute_values_CASE",
        ...
        builder.HasKey(x => new { x.VariantId, x.AttributeCode });
