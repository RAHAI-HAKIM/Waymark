...
public sealed class AppendOnlyTests : IClassFixture<MigratedDatabaseFixture>
{
    ...
    [InlineData("trg_receivable_movements_no_update")]
    [InlineData("trg_receivable_movements_no_delete")]
    [InlineData("trg_rec_decisions_no_update")]
    [InlineData("trg_rec_decisions_no_delete")]
    [InlineData("trg_erasure_ledger_no_delete")]
    [InlineData("trg_erasure_ledger_facts_fixed")]
    [InlineData("trg_erasure_ledger_executed_final")]
    [InlineData("trg_erasure_ledger_time_flow")]
    [InlineData("trg_erasure_ledger_time_flow_on_insert")]
    ...
    [InlineData("trg_consent_events_no_replace")]
    [InlineData("trg_stock_movements_no_replace")]
    [InlineData("trg_loyalty_movements_no_replace")]
    [InlineData("trg_credit_movements_no_replace")]
    [InlineData("trg_receivable_movements_no_replace")]
    [InlineData("trg_recommendation_decisions_no_replace")]
